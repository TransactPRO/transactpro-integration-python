...
from transactpro.request import Request

import pycurl
import transactpro.response as response


class TestRequest(TestCase):
    @patch('transactpro.request.StringIO.StringIO')
    @patch('transactpro.request.pycurl.Curl')
